...
export const VERIFAI_DATA = {
  ...
  claims: {
    ...
    c2: {
      ...
      worstVerdict: "low",
      calibrated: false,
      sourceIds: ["johnson", "harvard2019", "meta2021"],
    },
    c3: {
      id: "c3",
      ...
      calibrated: false,
      sourceIds: ["who", "efsa2015", "fda2018"],
    },
  },
  ...
  answerV2: [
    ...
    [
      { t: "Moderate doses can improve reaction time " },
      { t: "in the 8–11% range (corrected per your calibration)", claim: "c1", updated: true },
